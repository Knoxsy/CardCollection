...
(function(){
    ...
    (function() {
    var p = "3487963", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_3487963||'',
    GUID:window.ftGUID_3487963||'99999999999',
    confID:window.ftConfID_3487963||'0',
    ftReturn: window.ftReturn_3487963||'',
    keyword:window.ftKeyword_3487963||'',
    ftId:window.ftId_3487963||'',
    imp:window.ftImp3487963,
    ftImpId:window.ftImp3487963 && window.ftImp3487963.impID || '',
    campaignID:'90586',
    cID:'84849',
    pID:'3487963',
    creativeID:'2185939',
    exttrack:[],
    extscript:["https://cdn.doubleverify.com/dvtp_src.js?ctx=11919364&cmp=90586&sid=5056&plc=3487963&num=&adid=&advid=&adsrv=29&region=30&btreg=3487963&btadsrv=flashtalking&crt=2185939&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src"],
    clickTags: ["http://servedby.flashtalking.com/click/8/90586;3487963;2185939;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.sling.com/pm/homepage?&DS=1&utm_medium=display&utm_source=gdn&utm_campaign=SLGD_ACQ_MTAGAXX_COUSA_AW_DB_WTCP_ENTFA_000000XXX_2PGG_XXXX_CUSAXCHXEXXXX_XXXXX_COUSA_DWXEN_WWWXOA_RELE_EV_EN_H5_728X090&utm_content=realityepg"],
    placementDescription:'ENTFA000000XXX2PGGXXXXCUSAXCHXEXXXXXXXXXCOUSADWXENWWWXOARELEEVENH5728X090',
    width:728,
    height:90,
    ...
    divID:'ftdiv3487963',
    phID:'ftpos3487963',
    frameID:'ftframe3487963',
    expID:'ftexpframe3487963',
    altImgID:'ftalt3487963',
    altText:'Click here',
    altImgTarget:'_blank',
    altimghref:'http://servedby.flashtalking.com/click/8/90586;3487963;2185939;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.sling.com/pm/homepage?&DS=1&utm_medium=display&utm_source=gdn&utm_campaign=SLGD_ACQ_MTAGAXX_COUSA_AW_DB_WTCP_ENTFA_000000XXX_2PGG_XXXX_CUSAXCHXEXXXX_XXXXX_COUSA_DWXEN_WWWXOA_RELE_EV_EN_H5_728X090&utm_content=realityepg',
    altImg:'http://servedby.flashtalking.com/imp/8/90586;3487963;204;gif;GoogleDisplayNetwork;ENTFA000000XXX2PGGXXXXCUSAXCHXEXXXXXXXXXCOUSADWXENWWWXOARELEEVENH5728X090/?',
    viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/90586;3487963;271;pixel;GoogleDisplayNetwork;ENTFA000000XXX2PGGXXXXCUSAXCHXEXXXXXXXXXCOUSADWXENWWWXOARELEEVENH5728X090/?',
    stump:'http://servedby.flashtalking.com',
    jsurl:'http://cdn.flashtalking.com/xre/348/3487963/2185939/js/j-3487963-2185939.js',
    file:'http://cdn.flashtalking.com/84849/2185939/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM:'http://cdn.flashtalking.com',
    statBaseURL:'http://stat8.flashtalking.com/reportV3/ft.stat?123567094-3487963;2185939;',
    adVis:true ? 1 : 0,
    centreAd:true,
    mvt:true,
    segment:window.ftSegment_3487963||'',
    segmentList:window.ftSegmentList_3487963||[],
    ftlocal:'flashtalking/ftlocal.html',
    attachtobody:false,
    zIndex:77000,
    blockBrowsers:'ie11'.split(','),
    ...
    baggyFrameLimit:15,
    append:!!(window.ftImp3487963 && window.ftImp3487963.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m3487963')&&/^https:/.test(document.getElementById('ftscript_m3487963').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m3487963'),
    ...
    qsVars:[
        ['ftguid', 'ftGUID_3487963'],
        ['ftcfid', 'ftConfID_3487963'],
        ['fttime', 'ftTimestamp_3487963'],
        ['ftsection', 'ftSection_3487963'],
        ['ftcustom', 'ftCustom_3487963'],
        ['ft_id', 'ftId_3487963'],
        ['ftimpid','ftImp3487963', 'impID']
    ]
};
...
(function(ft){
    ...
    ft.viewableImpression = "http://servedby.flashtalking.com/imp/8/90586;3487963;202;pixel;GoogleDisplayNetwork;ENTFA000000XXX2PGGXXXXCUSAXCHXEXXXXXXXXXCOUSADWXENWWWXOARELEEVENH5728X090/?ft_creative=2185939&ft_configuration=";
    ft.viewableConversion = "true"==="true";
